 ...
 *
 * <p>Wraps the project's {@link DB} JdbcTemplate-style helper so callers work with
...
public class UserRepository {
    ...
    public void insertNewUser(String name, String passwordHash) throws SQLException {
        db.update("INSERT INTO tbluser VALUES (?,?,0,0,720,100,1,'Unemployed',1,1,0,0)",
                name, passwordHash);
    }
    ...
    public void resetUser(String name) throws SQLException {
        db.update("UPDATE amissdb.tbluser SET `xpos` = 0, `ypos` = 0, `time` = 720, `cash` = 100, "
