...
public class ApplianceStoreGUI extends javax.swing.JFrame {
     ...
     * @param d db object
     */
    public ApplianceStoreGUI(User u, DB d) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblBackground.setIcon(amiss.Assets.icon("screens/ApplianceStore.png"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApplianceStoreGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
