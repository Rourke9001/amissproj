...
/**
 * Placeholder screen for the Le Security Apartments stop. Navigable (shows time/cash and returns to the
 * board) but has no store actions yet — the full shop is future work. See ROADMAP backlog.
 */
public class LeSecurityApartmentsGUI extends javax.swing.JFrame {
    ...
    public LeSecurityApartmentsGUI(User u, GameServices services) {
        initComponents();
        user = u;
    ...
    private void initComponents() {
        ...
        setTitle("Le Security Apartments");
        ...
        txaNotification.setText("Welcome to Le Security Apartments.\n\n(Coming soon.)");
        ...
        lblBackground.setIcon(amiss.presentation.assets.Assets.icon("screens/LeSecurity.png"));
