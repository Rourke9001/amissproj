...
import amiss.domain.model.UserGoals;
...
public class LoginGUI extends javax.swing.JFrame {
    ...
    UserRepository users = ctx.users();
    UserStatsRepository userStats = ctx.userStats();
    String user, passwrd;
    ...
    private void initComponents() {
        ...
        lblBackground.setIcon(amiss.presentation.assets.Assets.icon("screens/Login.png"));
    ...
    private void btnCreateUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateUserActionPerformed
        try {
            ...
            if (!Validation.isValidPassword(passwrd)) {
                ...
                User newUser = new User(user, 0, 2, 4320, 100, 1, "Unemployed", 1, 1, 0, 0);//create new user object
