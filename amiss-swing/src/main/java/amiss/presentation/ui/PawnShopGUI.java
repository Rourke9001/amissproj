...
/**
 * Placeholder screen for the Pawn Shop stop. Navigable (shows time/cash and returns to the
 * board) but has no store actions yet — the full shop is future work. See ROADMAP backlog.
 */
public class PawnShopGUI extends javax.swing.JFrame {
    ...
    public PawnShopGUI(User u, GameServices services) {
        initComponents();
        user = u;
    ...
    private void initComponents() {
        ...
        txaNotification.setText("Welcome to the Pawn Shop.\n\n(Coming soon.)");
        ...
        lblBackground.setIcon(amiss.presentation.assets.Assets.icon("screens/PawnShop.png"));
